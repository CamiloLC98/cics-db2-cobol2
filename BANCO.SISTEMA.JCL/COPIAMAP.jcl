//COMPIMAP JOB WEYLAND,'URTZI LARRIETA',NOTIFY=&SYSUID,
...
//             SPACE=(800,(500,500))
//SYSIN    DD  DSN=BANCO1.SISTEMA.MAPS(XXXXXX),DISP=SHR
//SYSPRINT DD  SYSOUT=*
//SYSUDUMP DD  SYSOUT=*
//*
...
//SYSPUNCH DD DSN=BANCO1.SISTEMA.COPY(XXXXXXCP),DISP=SHR
//SYSIN    DD DSN=BANCO1.SISTEMA.MAPS(XXXXXX),DISP=SHR
